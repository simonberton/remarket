...
/**
 * @extends ServiceEntityRepository<Envase>
 *
...
class EnvaseRepository extends ServiceEntityRepository
{
    ...
    public function add(Envase $entity, bool $flush = false): void
    {
    ...
    public function remove(Envase $entity, bool $flush = false): void
    {
